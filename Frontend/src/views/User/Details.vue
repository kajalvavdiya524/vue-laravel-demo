            ...
            <template v-if="skipHotel===false">
              ...
              <b-form-row>
                ...
                <b-form-group class="text-left mb-0 col-md-6">
                  ...
                  <ValidatedField name="zip" v-model.trim="zip" type="number" purenumber integer class="mb-3"
                                  autocomplete="postal-code" rules="required|numeric"
              ...
              <b-form-row>
                ...
                <b-form-group class="text-left mb-0 col-md-6">
                  ...
                  <ValidatedField name="country" v-model="country" type="select" class="mb-3" rules="required"
                                  ...
                                  :error-bag="validationError" :disabled="pending || countries==null"/>
                </b-form-group>
              </b-form-row>
              ...
              <b-form-row>
                ...
                <b-form-group class="text-left mb-0 col-md-6">
                  ...
                  <drop-down
                    ...
                    :disabled="pending || currencies==null" v-model="currency_id"/>
                </b-form-group>
              </b-form-row>
            </template>
    ...
    methods: {
      ...
      async submitForm() {
        ...
        if (!this.pdFilled) {
          ...
          const {
            // eslint-disable-next-line camelcase
            country, city, zip, htel, street, name, email, currency_id,
          } = this;
          await this.updateProfile({
            country,
            city,
