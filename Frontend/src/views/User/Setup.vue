  ...
  <div class="page-setup" :class="pageClass">
    ...
    <ValidationObserver ref="setupForm" tag="div" class="w-100 d-flex d-md-block flex-grow-1 flex-md-grow-0">
      ...
      <div v-else class="steps">
          ...
          <div class="edge-block">
            ...
            <div class="row">
              <div class="col-12 cell-currency">
                ...
                <drop-down id="currency" v-model="step1.currency_id" :items="allCurrencies"
        ...
        <div class="buttons">
          <b-btn v-if="setupStep < 5" variant="outline-primary" @click="prevStep" :disabled="pending">
            {{ $t('buttons.back') }}
          </b-btn>
...
<script>
  import { externalEngineURL } from '@/shared';
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters('user', ['user', 'hotelName', 'hotelID', 'pending', 'validationError', 'setupStep', 'hotel']),
